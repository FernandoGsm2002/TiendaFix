...
export default function TechnicianDashboardLayout({ children }: TechnicianDashboardLayoutProps) {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 relative overflow-hidden">
        ...
        <Card className="w-96 shadow-2xl border-0 bg-white/80 backdrop-blur-lg relative z-10">
          <CardBody className="text-center p-10">
            ...
            <p className="text-gray-600 font-medium">Preparando tu área de trabajo...</p>
  ...
  if (userProfile?.role !== 'technician') {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 relative overflow-hidden">
        ...
        <Card className="w-[500px] shadow-2xl border-0 bg-white/90 backdrop-blur-lg relative z-10">
          <CardBody className="text-center p-10">
            <div className="mb-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/50 to-indigo-50 relative overflow-hidden">
      ...
      <div className="min-h-screen max-w-screen-2xl mx-auto p-6 relative z-10">
